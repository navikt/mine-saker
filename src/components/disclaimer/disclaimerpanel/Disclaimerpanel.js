...
const Disclaimerpanel = () => {
  return (
    <Panel className="dokumentvisning-info">
      <Undertittel className="dokumentvisning-info-tittel">Derfor kan du ikke se alle dokumentene</Undertittel>
      <Normaltekst>
        ...
        <ul className="tekst-dokumentliste">
          ...
          <li>
            Dokumenter som gjelder saken din, men som er sendt av andre på vegne av deg. Det kan for eksempel være en
            lege, advokat, verge eller fullmektig.
          </li>
        </ul>
