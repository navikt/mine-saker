...
export const handlers = [
  get("https://www.api.nav.no/mine-saker-api/login/status", status),
  get("https://www.api.nav.no/mine-saker-api/sakstemaer", sakstemaer),
  get("https://www.api.innlogginsstatus.nav.no/auth", innloggingsstatus),
  getJournalposterWithParams("https://www.api.nav.no/mine-saker-api/journalposter"),
];
